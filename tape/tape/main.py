...
def create_train_parser(base_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument('--force_save', type=str, default='FALSE',
                        help="whether to save checkpoint early, and force quit")
    parser.add_argument('--time_or_name', type=str, default='time',
                        help="'time' for timestamp, others for specifying ckpt' name trailing")
    parser.add_argument('--weight_decay', type=float, default=0.01,
                        help="weight decay for parameters excluding bias, gamma, beta, LayerNorm")
    return parser
...
def run_train_distributed(args: typing.Optional[argparse.Namespace] = None) -> None:
    ...
    exp_name = utils.get_expname(args.exp_name, args.task, args.model_type, args.time_or_name)
